...
if iswindows:
    ...
    def adeptkeys():
        """
        Extracts the ADEPT activation keys from the activation.dat file.

        Returns:
            A tuple containing two lists:
            - The first list contains the extracted activation keys.
            - The second list contains the corresponding key names.

        Raises:
            ADEPTError: If the ADE activation.dat file cannot be found.
        """
